(function () {
    ...
    doughnut("chart-order-status", readJson("chart-order-status-labels", []), readJson("chart-order-status-values", []), [
        palette.blue, palette.green, palette.orange, palette.red, palette.purple, palette.slate
    ]);

    doughnut("chart-lead-status", readJson("chart-lead-status-labels", []), readJson("chart-lead-status-values", []), [
        palette.blue, "#0ea5e9", palette.green, palette.purple, palette.orange, palette.slate
    ]);
