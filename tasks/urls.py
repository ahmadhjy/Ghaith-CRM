...
urlpatterns = [
    ...
    path('services/save_all/<int:leadid>/', views.save_all_services, name='save_all_services'),
    path('service/update_checked_status/<int:service_id>/', views.update_checked_status, name='update_checked_status'),
    path('service/update_send_to_client/<int:service_id>/', views.update_send_to_client, name='update_send_to_client'),
    ...
    path('orders/supplier-services/', views.supplier_services_detail, name='supplier_services_detail'),
