...
from accounts_core.models import Client, Currency, Employee, Supplier, UserProfile
...
class StatementLineDetailsTests(TestCase):
    ...
    def test_statement_line_details_uses_notes_not_destination(self):
        invoice = SalesInvoice.objects.create(
            invoice_no="TMP-2",
            client=self.client_obj,
            sales_employee=self.employee,
